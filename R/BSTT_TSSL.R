...
#' \item eta.est: posterior samples of common covariate effects (p x b x n.save)
#' \item alpha.est: posterior samples of sparsity elements that identify
