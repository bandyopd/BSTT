...
This repository includes code for BSTT (Bayesian Skewed Tensor-t) model with sparsity inducing prior and tensor normal prior described in the paper "A New Class of Skewed Tensor Distributions", by Lee et al (2021+).
